...
$(PATH_INTERNAL_C)/parts/audio/decode/mp3_mini/src/%.o: $(PATH_INTERNAL_C)/parts/audio/decode/mp3_mini/%.c
	$(CC) -Wall $< -c -o $@

QB_AUDIO_DECODE_MP3_LIB := $(PATH_INTERNAL_C)/parts/audio/decode/mp3_mini/os/$(OS)/src.a
