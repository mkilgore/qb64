...
$(PATH_INTERNAL_C)/parts/audio/decode/ogg/src/%.o: $(PATH_INTERNAL_C)/parts/audio/decode/ogg/%.c
	$(CC) -Wall $< -c -o $@

QB_AUDIO_DECODE_OGG_LIB := $(PATH_INTERNAL_C)/parts/audio/decode/ogg/os/$(OS)/src.a
